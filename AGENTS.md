...
This project is indexed by GitNexus as **simple-2fa-next** (217 symbols, 416 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
