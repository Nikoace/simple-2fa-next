...
This project is indexed by GitNexus as **simple-2fa-next** (384 symbols, 802 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
