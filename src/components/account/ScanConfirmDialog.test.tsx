...
describe("ScanConfirmDialog", () => {
  ...
  it("shows issuer and name when item is provided", () => {
    render(<ScanConfirmDialog item={ITEM} onConfirm={vi.fn()} onCancel={vi.fn()} />);
  ...
  it("calls onConfirm with item when confirm button clicked", async () => {
    ...
    render(<ScanConfirmDialog item={ITEM} onConfirm={onConfirm} onCancel={vi.fn()} />);
  ...
  it("calls onCancel when cancel button clicked", async () => {
    ...
    render(<ScanConfirmDialog item={ITEM} onConfirm={vi.fn()} onCancel={onCancel} />);
